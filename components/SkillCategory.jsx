...
const SkillCategory = ({ skills, category }) => {
  return (
    <div className="p-4 border border-gray-300 bg-white rounded-md mb-4 shadow-lg">
      <p className="text-md uppercase font-semibold tracking-wider mb-5">
        {category}
      </p>
      {skills.map((skill) => {
        ...
        return (
          <div
            key={skill.name}
            className="flex gap-1 align-middle items-center mb-2"
          >
